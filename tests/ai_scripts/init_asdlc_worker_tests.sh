...
test_init_bootstraps_existing_git_root() {
  ...
  assert_file_exists "$repo_dir/.agents/skills/yasdef-worker-design/SKILL.md"
  ...
  assert_contains "$(cat "$repo_dir/.agents/skills/yasdef-worker-design/SKILL.md")" ".agents/skills/yasdef-worker-design/scripts/"
