...
#### Scenario: Done-branch recognised as implementation complete
- **WHEN** a branch named `step-{step}-{feature_id}-implementation-DONE` exists locally
- **THEN** resume evaluation treats implementation as complete and routes to `user_review`

#### Scenario: Done-branch recognised as user_review complete
- **WHEN** a branch named `step-{step}-{feature_id}-user-review-DONE` exists locally
- **THEN** resume evaluation treats user_review as complete and routes to `ai_audit`

#### Scenario: Original branch still recognised for backward compatibility
- **WHEN** a branch named `step-{step}-{feature_id}-implementation` exists without a `-DONE` variant
- **THEN** resume evaluation treats implementation as complete, same as before this change
