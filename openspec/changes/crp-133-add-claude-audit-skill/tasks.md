...
- [ ] 1.4a Copy `ai/codex/skills/yasdef-worker-ai-audit/scripts/append_follow_up_step.py` into `ai/claude/skills/yasdef-worker-ai-audit/scripts/` byte-for-byte.
...
- [ ] 4.1 In `tests/ai_scripts/init_asdlc_worker_tests.sh > test_init_bootstraps_existing_git_root`, add `assert_file_exists` assertions for every Claude skill artifact installed (`SKILL.md`, four scripts, four assets).
