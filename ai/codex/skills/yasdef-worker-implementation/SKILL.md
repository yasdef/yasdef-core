...
description: Run the YASDEF ASDLC worker implementation phase for an assigned step. Use when the orchestrator or user asks to implement runtime code from a completed step plan and design artifact, update step-plan checklist state, and finish implementation handoff.
metadata:
