...
Rules:
- Write generalizable rules only.
...
- **Trigger**: Condition or pattern that should trigger the rule
- **Rule**: Normative guidance to follow
- **How to verify**: Concrete checks, tests, or review steps to prove compliance
...
- **References**: `.asdlc_worker/user_review.md` `.codex/skills/yasdef-worker-user-review/assets/user_review_TEMPLATE.md`
